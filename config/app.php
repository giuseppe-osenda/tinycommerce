...
return [
    ...
    'Session' => [
        'defaults' => 'cake',
        'timeout'  => 10080, // in minuti (una  settimana)
        'ini' => [
            'session.cookie_lifetime' => 604800, // durata del cookie (in secondi = 1 settimana) per "sopravvivere" al fatto che il session timeout scade quando si chiude il browser
        ]
    ],
];
