...
namespace AQ_Test.Migrations
{
    ...
    [Migration("20240618105505_CartCanHaveNoClient")]
    partial class CartCanHaveNoClient
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AQ_Test.Models.Cart", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 6, 18, 12, 55, 5, 599, DateTimeKind.Local).AddTicks(282));
            ...
            modelBuilder.Entity("AQ_Test.Models.CartProduct", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 18, 12, 55, 5, 599, DateTimeKind.Local).AddTicks(640));
            ...
            modelBuilder.Entity("AQ_Test.Models.OrderProduct", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 18, 12, 55, 5, 599, DateTimeKind.Local).AddTicks(1412));
