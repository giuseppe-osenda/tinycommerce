...
namespace AQ_Test.Migrations
{
    ...
    [Migration("20240618091011_ImplementingManyToManyOrderProductAsCartProduct")]
    partial class ImplementingManyToManyOrderProductAsCartProduct
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AQ_Test.Models.Cart", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 6, 18, 11, 10, 10, 889, DateTimeKind.Local).AddTicks(1245));
            ...
            modelBuilder.Entity("AQ_Test.Models.CartProduct", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 18, 11, 10, 10, 889, DateTimeKind.Local).AddTicks(1558));
            ...
            modelBuilder.Entity("AQ_Test.Models.OrderProduct", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 18, 11, 10, 10, 889, DateTimeKind.Local).AddTicks(1692));
